...
#
# Commands:
#   war6 armory <gamertag> - Returns that players Grimoire Score.
#   war6 played <gamertag> - Returns that players Last played character and lightlevel
#   war6 inventory <gamertag> - Returns that players Last played character's equipped inventory
#   war6 vendor xur - Returns Xur's Inventory or a warning when he isn't available
#
